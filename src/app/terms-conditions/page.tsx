    ...
    <MainLayout>
      <div className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-white">
          ...
          <p>
            Welcome to CertiChain. These Terms and Conditions govern your use of
            our blockchain-based academic record-keeping platform and services.
            By accessing or using CertiChain, you agree to be bound by these
            Terms.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>"Platform"</strong> refers to the CertiChain website,
            ...
            <li>
              <strong>"Academic Records"</strong> refers to educational
              credentials, certificates, degrees, or other academic achievements
              stored on the blockchain through our Platform.
            </li>
          </ul>
          ...
          <p>
            ...
            account and connect a blockchain wallet. You are responsible for
          ...
          <p>
            ...
            and immutable. CertiChain is not responsible for any errors in the
            information you provide for blockchain transactions. You are solely
            responsible for verifying the accuracy of all information before
          ...
          <p>As a user of CertiChain, you agree to:</p>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <li>
              Maintain the security of your blockchain wallet and private keys
            </li>
          </ul>
          ...
          <p>
            ...
            exclusive property of CertiChain and are protected by copyright,
          ...
          <p>
            To the maximum extent permitted by law, CertiChain shall not be
          ...
          <p>
            ...
            warranties of any kind, either express or implied. CertiChain does
          ...
          <p>
            ...
            the laws of the jurisdiction in which CertiChain is established,
            without regard to its conflict of law provisions.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-4">Changes to Terms</h2>
          <p>
            CertiChain reserves the right to modify these Terms at any time. We
            will provide notice of any material changes by posting the updated
            Terms on the Platform and updating the "Last Updated" date. Your
